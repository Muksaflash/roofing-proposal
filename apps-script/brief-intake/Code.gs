...
function buildTextBody_(params, selectedServices) {
  var lines = [
    ...
    "",
    "QR website link: " + value_(params.qrWebsiteLink),
    "QR review links: " + value_(params.qrReviewLinks),
    "QR print use cases: " + value_(params.qrPrintUseCases),
    "QR print notes: " + value_(params.qrPrintNotes),
    "",
...
function buildHtmlBody_(params, selectedServices) {
  var rows = [
    ...
    ["QR website link", params.qrWebsiteLink],
    ["QR review links", params.qrReviewLinks],
    ["QR print use cases", params.qrPrintUseCases],
    ["QR print notes", params.qrPrintNotes],
